...
export default async function DestinationInfoPage({
    ...
    const recommendationsItems = [
        ...
        { icon: Compass, label: 'tours', slug: 'tours', color: 'text-indigo-500' },
        { icon: Waves, label: 'sea', slug: 'sea', color: 'text-cyan-500' },
    ...
    return (
        <div className="min-h-screen bg-background pb-20">
            ...
            <main className="container mx-auto max-w-md px-6 pt-4">
                {/* Title */}
                <h1 className="text-[22px] font-light text-center mb-5 text-foreground leading-tight">
