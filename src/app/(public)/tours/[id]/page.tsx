...
import { ChevronLeft, Share2, Heart, Ticket } from 'lucide-react'
    ...
    return (
        <div className="min-h-screen bg-slate-50 flex flex-col relative pb-10">
            ...
            <main className="container mx-auto max-w-md px-6 flex flex-col items-center">
                ...
                {/* Hero Image Block */}
                <div className="w-full relative rounded-xl overflow-hidden shadow-sm bg-slate-200 mt-2 mb-4" style={{ height: '380px' }}>
                ...
                <div className="flex justify-center -mt-2 mb-6">
                    <button
                        onClick={() => router.push(`/tours/${id}/book`)}
                ...
                <div className="w-full bg-white rounded-xl border border-slate-200 p-5 shadow-sm flex flex-col gap-5">
                    ...
                    <div className="flex justify-between items-start">
                        ...
                        <div className="text-[10px] text-slate-600 font-medium text-right leading-tight">
                            Monday - Friday<br />Morning, Night
                        </div>
                    </div>

                    {/* General Description */}
                    <div>
                        <h4 className="text-xs font-semibold text-slate-800 mb-2">General description of the experience</h4>
