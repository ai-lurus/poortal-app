...
export default function CultureShowDetailPage() {
        ...
        <div className="min-h-screen bg-slate-50 flex flex-col relative pb-10">
            ...
            <main className="container mx-auto max-w-md px-6 flex flex-col items-center">
                ...
                <div className="w-full relative rounded-xl overflow-hidden shadow-sm bg-slate-900 mt-2 mb-4" style={{ height: '380px' }}>
                    <div className="absolute inset-0 bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-800 flex flex-col p-6 pt-10">
                        <div className="text-rose-200 font-serif text-4xl leading-tight uppercase tracking-widest drop-shadow-md">ANDREA</div>
                        <div className="text-rose-200 font-serif text-4xl leading-tight uppercase tracking-widest mb-4 drop-shadow-md">BOCELLI</div>
                        <span className="text-white font-bold text-sm uppercase tracking-wide">26 FEBRERO 2022</span>
                        <span className="text-slate-300 font-medium text-xs uppercase tracking-wide leading-tight mt-2">
                ...
                <div className="flex justify-center -mt-2 mb-6">
                    {/* Reusing Nightlife Book flow for tickets since they are identical */}
                    <button
